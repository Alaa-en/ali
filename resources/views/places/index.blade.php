        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel"> إضافة مكان</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <form style="text-align: right;" method="POST" action="{{ route('places.store') }}">
                @csrf
                <div class="mb-3">
                  <label style="color: black" class="form-label">اسم المكان </label>
          ...
          <table class="table table-borderless">
            ...
            <tbody>
             @foreach ($places as $place)
              ...
              <tr>
                <td>
                  <form method="POST" action="{{ route('places.destroy',['id'=>$place->id]) }}">
                    @csrf
                    @method('DELETE')
                     <button type="submit">
                ...
                <td>
                  <a  class="btn"  href="{{ route('places.edit',['id'=>$place->id]) }}">
                    <button>
