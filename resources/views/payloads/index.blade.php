                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="flex flex-col w-full" method="POST" action="{{ route('payloads.store') }}">
                       
                                @csrf
                
                                <div class="mb-3">
                                    <label style="color: black" class="form-label">نوع الحموله</label>
                        ...
                        <tbody>
                           @foreach ($payloads as $payload )
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('payloads.destroy',['id'=>$payload->id]) }}">
                                       @csrf
                                       @method('DELETE')
                                        <button type="submit">
                                ...
                                <td>
                                    <a  class="btn"  href="{{ route('payloads.edit',['id'=>$payload->id]) }}">
                                        <button>
