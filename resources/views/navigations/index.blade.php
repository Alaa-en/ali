        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form style="text-align: right;" method="POST" action="{{ route('navigations.store') }}">
                @csrf
                <div class="mb-3">
                  <label style="color: black" class="form-label">إسم الملاحه</label>
                  <input name="name" type="text" class="form-control">
                </div>
                <div class="mb-3">
                  <label style="color: black" class="form-label">عنوان الملاحه </label>
          ...
          <table class="table table-borderless">
            ...
            <tbody>
             @foreach ($navigations as $navigation)
              ...
              <tr>
                <td>
                  <form method="POST" action="{{ route('navigations.destroy',['id'=>$navigation->id]) }}">
                    @csrf
                    @method('DELETE')
                     <button type="submit">
                ...
                <td>
                  <a  class="btn"  href="{{ route('navigations.edit',['id'=>$navigation->id]) }}">
                    <button>
