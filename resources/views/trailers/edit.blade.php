        ...
        <div class="row" style="text-align: right;">
            ...
            <div >
                        ...
                        <div >
                            ...
                            <form class="flex flex-col w-full" method="POST" action="{{ route('trailers.update',['id'=>$trailer->id])}}">
                                @method('put')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="number" value="{{ $trailer->number}}" type="text" class="form-control">
                                </div>
