                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"> إضافةرقم المقطوره</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
             
                            <form class="flex flex-col w-full" method="POST" action="{{ route('trailers.store') }}">
                        ...
                        <tbody>
                           @foreach ($trailers as $trailer )
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('trailers.destroy',['id'=>$trailer->id]) }}">
                                       @csrf
                                       @method('DELETE')
                                        <button type="submit">
                                ...
                                <td>
                                    <a  class="btn"  href="{{ route('trailers.edit',['id'=>$trailer->id]) }}">
                                        <button>
