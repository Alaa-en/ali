        ...
        <div class="row" style="text-align: right;">
            ...
            <div >
                        ...
                        <div >
                            ...
                            <form class="flex flex-col w-full" method="POST" action="{{ route('drivers.update',['id'=>$driver->id])}}">
                                @method('put')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="phone" value="{{ $driver->phone}}" type="text" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label style="color: black" class="form-label">رقم الهوية</label>
                                    <input name="identity" value="{{ $driver->identity}}" type="text" class="form-control">
                                </div>
