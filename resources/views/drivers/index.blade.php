        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel"> إضافة سواق</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <form style="text-align: right;" method="POST" action="{{ route('drivers.store') }}">
                @csrf
                <div class="mb-3">
          ...
          <table class="table table-borderless">
            ...
            <tbody>
             @foreach ($drivers as $driver)
              ...
              <tr>
                <td>
                  <form method="POST" action="{{ route('drivers.destroy',['id'=>$driver->id]) }}">
                    @csrf
                    @method('DELETE')
                     <button type="submit">
                ...
                <td>
                  <a  class="btn"  href="{{ route('drivers.edit',['id'=>$driver->id]) }}">
                    <button>
