        ...
        <div class="row" style="text-align: right;">
            ...
            <div >
                        ...
                        <div >
                            ...
                            <form class="flex flex-col w-full" method="POST" action="{{ route('carheads.update',['id'=>$carhead->id])}}">
                                @method('put')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="number" value="{{ $carhead->number}}" type="text" class="form-control">
                                </div>
