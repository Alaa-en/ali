                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="flex flex-col w-full" method="POST" action="{{ route('carheads.store') }}">
                        ...
                        <tbody>
                           @foreach ($carheads as $carhead )
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('carheads.destroy',['id'=>$carhead->id]) }}">
                                       @csrf
                                       @method('DELETE')
                                        <button type="submit">
                                ...
                                <td>
                                    <a  class="btn"  href="{{ route('carheads.edit',['id'=>$carhead->id]) }}">
                                        <button>
