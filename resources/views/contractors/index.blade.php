        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel"> إضافة مقاول</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <form style="text-align: right;"  method="POST" action="{{ route('contractors.store') }}">
                @csrf
                <div class="mb-3">
                  <label style="color: black" class="form-label">إسم المقاول</label>
          ...
          <table class="table table-borderless">
            ...
            <tbody>
             @foreach ($contractors as $contractor)
              ...
              <tr>
                <td>
                  <form method="POST" action="{{ route('contractors.destroy',['id'=>$contractor->id]) }}">
                    @csrf
                    @method('DELETE')
                     <button type="submit">
                ...
                <td>
                  <a  class="btn"  href="{{ route('contractors.edit',['id'=>$contractor->id]) }}">
                    <button>
